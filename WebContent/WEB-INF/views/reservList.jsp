<%@page import="com.model.ReservDto"%>
...
<%
List<ReservDto> list = (List<ReservDto>)request.getAttribute("reservList");
%>    
		...
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="height: 70px; border-radius: 0.5rem;">
			...
			<div class="collapse navbar-collapse" id="navbarText">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item"><span style="font-size: 15pt;color: rgba(255, 255, 255, 0.5);line-height:45px">|</span></li>
					<li class="nav-item active"><a class="nav-link" href="reservList.do?id=<%=mem.getId() %>" style="font-size:15pt">예매 내역</a></li>
				</ul>
				<% if(mem != null){ %>
	  	...
	  	<div style="overflow: auto;">
		  	<table class="table">
		  		...
		  		<thead align="center" class="thead-light">
			  		<tr>
			  			<th>예매시간</th><th>영화제목</th><th>상영관</th><th>상영시간</th>
			  		</tr>
				...
				%>
					<tr>
						<td><%=dto.getRevDate() %></td>
						<td><%=dto.getTitle() %></td>
						<td><%=dto.getTheater() %></td>
						<td><%=dto.getMovTime() %></td>
		  	...
		  	<div align="justify" style="float:left; width:280px;height:280px;padding-top: 50px; padding-left: 50px">
			  	...
			  	<button type="button" class="btn btn-info" onclick="location.href='reservList.do'">모든 예약 확인</button>
		  	</div> --%>
	  	</div>
	  </div>
	 </div>
